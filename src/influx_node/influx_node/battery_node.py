...
class TelemetryNode(Node):
    ...
    def __init__(self):
        ...
        self.create_subscription(Int32,  '/danger_detected',    self.cb_danger,     10)
    ...
    def cb_danger(self, msg):
        self.danger_detected = int(msg.data)
        # Envoi immédiat si danger détecté — pas d'attente du timer
        if self.danger_detected == 1:
            self.send_all()
            self.get_logger().info("Danger détecté — envoi immédiat")
    ...
    def send_all(self):
        try:
            point = (
                ...
                # Détection danger
                .field("danger_detected", self.danger_detected)
            ...
            self.get_logger().info(
                ...
                f"bat={self.battery} danger={self.danger_detected} "
